...
class CompetitionsControllerTest < ActionController::TestCase
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post :create, competition: { event_id: @competition.event_id, message: @competition.message, user_id: @competition.user_id }
    end
  ...
  test "should update competition" do
    put :update, id: @competition, competition: { event_id: @competition.event_id, message: @competition.message, user_id: @competition.user_id }
    assert_redirected_to competition_path(assigns(:competition))
  end
